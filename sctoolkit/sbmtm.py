## code is based on https://github.com/martingerlach/hSBM_Topicmodel/ and https://github.com/fvalle1/hSBM_Topicmodel/tree/develop_share
    ...
    def fit(self, overlap=False, hierarchical=True, B_min=None, B_max=None, n_init=1, n_init_jobs=1, parallel=False, verbose=False):
        ...
        if g is None:
            ...
            if n_init_jobs == 1:
                ...
                runs = Parallel(n_init_jobs=n_init_jobs)(delayed(gt.minimize_nested_blockmodel_dl)(g,
                                                                                         deg_corr=True,
                                                                                         overlap=overlap,
                                                                                         B_min=B_min,
                                                                                         state_args=state_args,
